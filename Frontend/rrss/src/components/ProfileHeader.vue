    ...
    <div class="user-info">
      ...
      <div class="user-details">
        ...
        <div class="actions">
          ...
          <router-link v-if="this.$route.params.userId == currentUserId & (user.isAdmin | user.isModerator)" to="/admin-panel" class="action-button">Admin Panel</router-link>
          <router-link v-if="this.$route.params.userId == currentUserId & (user.isAdmin | user.is_merchant | user.isModerator)" to="/add-product" class="action-button">Add Product</router-link>
